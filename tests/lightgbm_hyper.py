...
lightgbm_parameter = {'boosting_type': ['gbdt', 'dart', 'goss'],
...
for feature in retain_feature:
    ...
    tensile_data_set.random_search(gbm.LGBMRegressor(), lightgbm_parameter)
    ...
    pmb_data_set.random_search(gbm.LGBMRegressor(), lightgbm_parameter)
    ...
    iron_data_set.random_search(gbm.LGBMRegressor(), lightgbm_parameter)
